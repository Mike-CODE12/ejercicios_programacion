...
#     ◦ Separa el proceso de retiro del constructor.
#     ◦ Llama al método withdraw_money desde una instancia y no desde la inicialización.
...
print(second_account.withdrawal_approval_check(46000))