...
from Actions import list_of_dictionaries, list_of_students, list_of_average_grade_per_student, top_3, list_for_the_group_average_grade, gather_information, view_information_of_students, get_top_3, get_group_average_grade
    ...
    while True:
        ...
        if option==1:
            ...
            if len(list_of_students)>=1:
                write_csv_file("Information_of_students.csv", list_of_dictionaries, list_of_dictionaries[0].keys())
            else:
