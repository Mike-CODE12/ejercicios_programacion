...
#Primero crear una funcion que le permita ingresar al usuario la información de un juego
#Y esta información pase a ser un diccionario
#Debe ser un ciclo para que el usuario pueda agrega más de un juego como diccionario
#Sería mejor realizar una lista con estos diccionarios
