...
#Option2:     #Necesito iterar la lista e imprimir los atributos
def view_information_of_students():
    if len(list_of_students) >= 1:
        for student_object in list_of_students: #Yo no estoy creando un objeto nuevo, pero El bucle for simplemente asigna cada objeto(ya creado) a la variable student_object en cada iteración.#No se sustituyen los objetos, sino que student_object es solo una referencia temporal al objeto actual en la iteración.
